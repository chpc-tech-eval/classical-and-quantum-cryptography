#!/usr/bin/env python3
"""
ASCOT5 Benchmark 2: Alpha Particle Slowing-Down - 200k Markers
"""
import numpy as np
from a5py import Ascot

print("=" * 70)
print("ASCOT5 Benchmark 2 Setup - 200,000 Markers")
print("=" * 70)

# Configuration
n_markers = 200000  # CHANGED: Scaled from 8,000 to 200,000
print(f"Markers: {n_markers:,}")
print("=" * 70)

# Create HDF5 file
print("\nCreating HDF5 file...")
a5 = Ascot("benchmark2.h5", create=True)
...
opt.update({
    ...
    # CHANGED: Increased resolution for better statistics with 200k markers
    "DIST_MIN_R": 4.3,
    "DIST_MAX_R": 8.3,
    "DIST_NBIN_R": 80,  # CHANGED: 50 -> 80 (60% increase)
    
    "DIST_MIN_Z": -2.0,
    "DIST_MAX_Z": 2.0,
    "DIST_NBIN_Z": 80,  # CHANGED: 50 -> 80 (60% increase)
    ...
    "DIST_NBIN_PPA": 150,  # CHANGED: 100 -> 150 (50% increase)
    
    "DIST_MIN_PPE": 0,
    "DIST_MAX_PPE": 1.3e-19,
    "DIST_NBIN_PPE": 80,  # CHANGED: 50 -> 80 (60% increase)
    
    # rho5D distribution grid (rho, theta, phi, ppar, pperp)
    # CHANGED: Increased rho resolution for better radial profiles
    "DIST_MIN_RHO": 0,
    "DIST_MAX_RHO": 1.0,
    "DIST_NBIN_RHO": 150,  # CHANGED: 100 -> 150 (50% increase)
...
a5.data.create_input("opt", **opt, desc="Benchmark1_200k")

print("\n" + "=" * 70)
print("Setup Complete!")
print("=" * 70)
print("\nConfiguration Summary:")
print(f"  File: benchmark2.h5")
print(f"  Markers: {n_markers:,}")
...
print(f"  Distributions: 5D (80×80×150×80) + rho5D (150)")
print("=" * 70)